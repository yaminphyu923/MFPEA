...
@section('active-member-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Active Members <small>Members listing</small></b></h4>
                            ...
                            @foreach ($annual_fees as $annual_fee)
                                <tr>
                                    ...
                                    <a href="{{ route('send-mail', $annual_fee->member->id) }}">
                                        <button type="button" class="btn btn-sm btn-primary py-2 px-1">
                                            Send Mail</button>
                                    </a>
