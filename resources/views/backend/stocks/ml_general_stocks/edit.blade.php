            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Edid Micro Lab General Stock</small></b></h4>
                ...
                <div class="col-sm-12">
                    <div class="card bg-primary text-light">
                        ...
                        <form action="{{ route('ml_general_stock.update', $ml_general_stock->id) }}" method="POST"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="item_name" id="item_name" class="form-control"
                                                    value="{{ $ml_general_stock->item_name }}">
                                            </div>

                                            <label class="col-sm-2">Description</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="description" id="description"
                                                    class="form-control" value="{{ $ml_general_stock->description }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="date" name="date" id="date" class="form-control"
                                                    value="{{ $ml_general_stock->date }}">
                                            </div>
                                            <label class="col-sm-2">Stock</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="stock" id="stock" class="form-control"
                                                    value="{{ $ml_general_stock->stock }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="total_stock" id="total_stock"
                                                    class="form-control" value="{{ $ml_general_stock->total_stock }}">
                                            </div>
                                            <label class="col-sm-2">Remark</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="remark" id="remark" class="form-control"
                                                    value="{{ $ml_general_stock->remark }}">
                                            </div>
                                        </div>
                                    </div>
