        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Purchase Micro Lab Media Stock List</small></b></h4>
            ...
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('purchase_ml_media_stock.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($ml_media_stocks as $ml_media_stock)
                                <tr>
                                    ...
                                    <td>{{ date('d-M-Y', strtotime($ml_media_stock->purchase_date)) }}</td>
                                    <td>{{ $ml_media_stock->purchase_stock }}</td>
                                    {{-- <td>
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'DELETE',
                        url: '/purchase_ml_media_stock/' + id,
                        success: function() {
                            Swal.fire({
                                icon: 'success',
