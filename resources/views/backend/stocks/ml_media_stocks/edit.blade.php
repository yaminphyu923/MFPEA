            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Edid Micro Lab Media Stock</small></b></h4>
                ...
                <div class="col-sm-12">
                    <div class="card bg-primary text-light">
                        ...
                        <form action="{{ route('ml_media_stock.update', $ml_media_stock->id) }}" method="POST"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="description" id="description"
                                                    class="form-control" value="{{ $ml_media_stock->description }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="balance_bot" id="balance_bot"
                                                    class="form-control" value="{{ $ml_media_stock->balance_bot }}">
                                            </div>
                                        ...
                                        <div class="form-group row mx-2">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="total_stock" id="total_stock"
                                                    class="form-control" value="{{ $ml_media_stock->total_stock }}">
                                            </div>
