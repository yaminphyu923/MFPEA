        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Purchase Micro Lab Equipment List</small></b></h4>
            ...
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('purchase_ml_equipment_list.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($pu_ml_equipment_lists as $pu_ml_equipment_list)
                                <tr>
                                    ...
                                    <td>{{ date('d-M-Y', strtotime($pu_ml_equipment_list->purchase_date)) }}</td>
                                    <td>{{ $pu_ml_equipment_list->purchase_stock }}</td>
                                    {{-- <td>
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'DELETE',
                        url: '/purchase_ml_equipment_list/' + id,
                        success: function() {
                            Swal.fire({
                                icon: 'success',
