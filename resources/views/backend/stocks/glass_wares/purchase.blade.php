            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Purchase Chemical Lab(Glass Wares)</h4>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('purchase_glass_ware.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($stock_glass_wares as $gw)
                                <tr>
                                    ...
                                    <td>{{ date('d-M-Y', strtotime($gw->purchase_date)) }}</td>
                                    <td>{{ $gw->purchase_stock }}</td>
                                    {{-- <td>
