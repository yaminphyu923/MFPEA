        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Purchase Chemical Lab Chemical List</small></b></h4>
            ...
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('purchase_chemical_list.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($stock_pu_chemical_lists as $stock_pu_chemical_list)
                                <tr>
                                    ...
                                    <td>{{ date('d-M-Y', strtotime($stock_pu_chemical_list->purchase_date)) }}</td>
                                    <td>{{ $stock_pu_chemical_list->purchase_stock }}</td>
                                    {{-- <td>
