        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Used Micro Lab Petrifilm Stock List</small></b></h4>
            ...
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('used_ml_petrifilm_stock.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($ml_petrifilm_stocks as $ml_petrifilm_stock)
                                <tr>
                                    ...
                                    <td>{{ $ml_petrifilm_stock->used_stock }}</td>
                                    <td>{{ date('d-M-Y', strtotime($ml_petrifilm_stock->used_date)) }}</td>
        ...
        $(document).on('click', '.delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'DELETE',
                        url: '/used_ml_petrifilm_stock/' + id,
                        success: function() {
                            Swal.fire({
                                icon: 'success',
