        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Used Chemical Lab Equipment List</small></b></h4>
            ...
            <div class="col-sm-6">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('used_cl_equipment_list.store') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            @foreach ($pu_cl_equipment_lists as $pu_cl_equipment_list)
                                <tr>
                                    ...
                                    <td>{{ date('d-M-Y', strtotime($pu_cl_equipment_list->used_date)) }}</td>
                                    <td>{{ $pu_cl_equipment_list->used_stock }}</td>
                                    {{-- <td>
