...
@section('fche040038-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/38</b></h4>
                    </div>

                    <form action="{{ route('fche040038.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="water" class="form-control"
                                                value="Volume of Water (For boil)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sample" class="form-control"
                                                value="Volume of Sample titer (S)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ash_cal" class="form-control"
                                                value="Alkalinity of soluble ash (as K2O) % = ((S-B)*N*0.047/wt)*100">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ash" class="form-control"
                                                value="Alkalinity of soluble ash (as K2O) %">
                                        </div>
                                    </div>
                                </div>
