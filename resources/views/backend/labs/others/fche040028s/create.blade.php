            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/28</b></h4>
                    </div>

                    <form action="{{ route('fche040028.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="first_boiling" class="form-control"
                                                value="Time for First Boiling (hr)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="second_boiling" class="form-control"
                                                value="Time for Second Boiling (hr)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="residue" class="form-control"
                                                value="Weight of Residue for 250ml">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="extractive_cal" class="form-control"
                                                value="Extractive (%) = (Residue/wt)*100">
                                        </div>
                                    </div>
                                </div>
