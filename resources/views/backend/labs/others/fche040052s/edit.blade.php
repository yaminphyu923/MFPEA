...
@section('fche040052-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-00/52</b></h4>
                    </div>

                    <form action="{{ route('fche040052.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_titrant" class="form-control"
                                                value="{{ $che->hcl_titrant }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_titrant_test1" class="form-control"
                                                value="{{ $che->hcl_titrant_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_titrant_test2" class="form-control"
                                                value="{{ $che->hcl_titrant_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_normality" class="form-control"
                                                value="{{ $che->hcl_normality }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_normality_test1" class="form-control"
                                                value="{{ $che->hcl_normality_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_normality_test2" class="form-control"
                                                value="{{ $che->hcl_normality_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="naoh_cal" class="form-control"
                                                value="{{ $che->naoh_cal }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="naoh_cal_test1" class="form-control"
                                                value="{{ $che->naoh_cal_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="naoh_cal_test2" class="form-control"
                                                value="{{ $che->naoh_cal_test2 }}">
                                        </div>
                                    </div>
                                </div>
