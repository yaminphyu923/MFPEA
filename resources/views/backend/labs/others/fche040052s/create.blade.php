            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/52</b></h4>
                    </div>

                    <form action="{{ route('fche040052.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="Titration Method (AOCS, Da 4a-48)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="alcohol" class="form-control"
                                                value="Volume of alcohol (Neutralized)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_titrant" class="form-control"
                                                value="Volume of Titrant of HCL solution">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="naoh_cal" class="form-control"
                                                value="Free alkali as NAOH % = (Volume of HCL * N of HCL * 4)/sample wt">
                                        </div>
                                    </div>
                                </div>
