...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF FREE ALKALI</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-00/52</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->hcl_titrant }}</td>
                            <td>{{ $che->hcl_titrant_test1 }}</td>
                            <td>{{ $che->hcl_titrant_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->hcl_normality }}</td>
                            <td>{{ $che->hcl_normality_test1 }}</td>
                            <td>{{ $che->hcl_normality_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->naoh_cal }}</td>
                            <td>{{ $che->naoh_cal_test1 }}</td>
                            <td>{{ $che->naoh_cal_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/other_fche040052s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/other_fche040052s/checked_sign/' . $che->checked_sign) }}"
                            alt="" style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
