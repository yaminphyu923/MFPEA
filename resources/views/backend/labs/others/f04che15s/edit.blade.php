            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-04-Che/15</b></h4>
                    </div>

                    <form action="{{ route('f04che15.update', $f04che15->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                            ...
                                            <select name="customer_id" class="form-control myselect">
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}"
                                                        @if ($customer->id == $f04che15->customer_id) selected @endif>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">Sample Preparation</label>

                                        <div class="col-sm-8">
                                            <input type="text" name="sample_preparation" class="form-control"
                                                autocomplete="off" value="{{ $f04che15->sample_preparation }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sample_weight" class="form-control"
                                                autocomplete="off" value="{{ $f04che15->sample_weight }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="water_volume" class="form-control"
                                                autocomplete="off" value="{{ $f04che15->water_volume }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">Blending and Filtration</label>

                                        <div class="col-sm-8">
                                            <input type="text" name="blending" class="form-control"
                                                autocomplete="off" value="{{ $f04che15->blending }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
