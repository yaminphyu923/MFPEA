...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF BRIX</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/25</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $che->brix_reading }}</td>
                            <td>{{ $che->brix_reading_test1 }}</td>
                            <td>{{ $che->brix_reading_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->brix }}</td>
                            <td>{{ $che->brix_test1 }}</td>
                            <td>{{ $che->brix_test2 }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>

            <h6>df = dilution factor</h6>

            <h6>Remark : {{ $che->remark }}</h6>
            <div class="col-sm-6 my-3">

                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/other_fche040125s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/other_fche040125s/checked_sign/' . $che->checked_sign) }}"
                            alt="" style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
