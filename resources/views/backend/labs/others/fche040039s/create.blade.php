            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/39</b></h4>
                    </div>

                    <form action="{{ route('fche040039.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ki" class="form-control"
                                                value="Weight of Potassium Iodide (KI) (g)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="distilled_water" class="form-control"
                                                value="Volume of Distilled Water (ml)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="acetic_acid" class="form-control"
                                                value="Volume of Acetic acid (ml)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sodium" class="form-control"
                                                value="Normality of Sodium thiosulphate solution(N)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="cl_cal" class="form-control"
                                                value="Available Chlorine (as Cl)= ((S-B)*N*3.546)/Volume of sample">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="cl" class="form-control"
                                                value="Available Chlorine (as Cl) Percent mass by Volume">
                                        </div>
                                    </div>
                                </div>
