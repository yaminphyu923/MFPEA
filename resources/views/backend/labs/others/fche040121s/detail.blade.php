...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF SUGAR</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/21</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $che->mass }}</td>
                            <td>{{ $che->mass_test1 }}</td>
                            <td>{{ $che->mass_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->sugar_cal }}
                                <br> f = correction factor
                            </td>
                            <td>{{ $che->sugar_cal_test1 }}</td>
                            <td>{{ $che->sugar_cal_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->sugar }}</td>
                            <td>{{ $che->sugar_test1 }}</td>
                            <td>{{ $che->sugar_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/other_fche040121s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/other_fche040121s/checked_sign/' . $che->checked_sign) }}"
                            alt="" style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
