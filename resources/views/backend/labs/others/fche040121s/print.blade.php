...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF SUGAR
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/21</div>
    </div>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/other_fche040121s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/other_fche040121s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif
