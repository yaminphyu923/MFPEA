...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORKSHEET FOR DETERMINATION OF ALCOHOL
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-04-Che/25</div>
    </div>
    ...
    <div class="flex-box">
        <table class="table table-stripped">
            <tr>
                <td>Job Number</td>
                <td>: {{ $f04che25->job_number != null ? $f04che25->job_number : '' }}</td>
            </tr>
            <tr>
                <td>Product Name</td>
            ...
            <tr>
                <td>Date Received</td>
                <td>: {{ $f04che25->received_date != null ? date('d-M-Y', strtotime($f04che25->received_date)) : '' }}
                </td>
            </tr>
            <tr>
                <td>Date Initiated for Analysis</td>
                <td>: {{ $f04che25->analysed_date != null ? date('d-M-Y', strtotime($f04che25->analysed_date)) : '' }}
                </td>
            </tr>
            <tr>
                <td>Date Reported</td>
                <td>: {{ $f04che25->reported_date != null ? date('d-M-Y', strtotime($f04che25->reported_date)) : '' }}
                </td>
            </tr>
            <tr>
                <td>Method</td>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            <h4>: <b>{{ $f04che25->analysed_name != null ? $f04che25->analysed_name : '' }}</b></h4>

            : @if ($f04che25->analysed_sign != null)
                <img src="{{ asset('photos/other_f04che25s/analysed_sign/' . $f04che25->analysed_sign) }}" alt=""
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            <h4>: <b>{{ $f04che25->checked_name != null ? $f04che25->checked_name : '' }}</b></h4>

            : @if ($f04che25->checked_sign != null)
                <img src="{{ asset('photos/other_f04che25s/checked_sign/' . $f04che25->checked_sign) }}" alt=""
                    style="width:100px;height:44px;">
