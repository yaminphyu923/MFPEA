            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-04-Che/25</b></h4>
                    </div>

                    <form action="{{ route('f04che25.update', $f04che25->id) }}" method="POST"
                                            ...
                                            <select name="customer_id" class="form-control myselect">
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}"
                                                        @if ($customer->id == $f04che25->customer_id) selected @endif>
