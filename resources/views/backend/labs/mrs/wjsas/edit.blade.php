            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        {{-- <a href="{{ route('wjsa_tests.index') }}">
                            <button type="button" class="btn btn-md btn-primary"><b>wjsa Analysis Test
                                    Parameter</b></button>
                        </a> --}}
                ...
                <div class="col-sm-12">
                    <div class="card bg-primary text-light">
                        ...
                        <form action="{{ route('wjsas.update', $wjsa->id) }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" name="test_performed_date" class="form-control"
                                                    value="{{ $wjsa->test_performed_date }}">
                                            </div>
                                        </div>
                                    </div>
