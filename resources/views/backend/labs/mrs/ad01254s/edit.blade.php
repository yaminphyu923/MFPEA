            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Ad-06-03-01254/22</b></h4>
                    </div>

                    <form action="{{ route('ad01254s.update', $ad->id) }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="before_result[]" class="form-control"
                                                        autocomplete="off" value="{{ $ad_test->before_result }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="after_result[]" class="form-control"
                                                        autocomplete="off" value="{{ $ad_test->after_result }}">
                                                </div>
                                            </div>
                                        </div>
