            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Ad-06-03-01254/22</b></h4>
                    </div>

                    <form action="{{ route('ad01254s.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="test">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 my-0">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-5">Before Result</label>

                                            <div class="col-sm-7">
                                                <input type="text" name="before_result[]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2 my-0">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-5">After Result</label>

                                            <div class="col-sm-7">
                                                <input type="text" name="after_result[]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $(".test").append(
                        ...
                        '<div class="col-sm-2">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Before Result </label>' +
                        ...
                        '<div class="col-sm-2">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">After Result </label>' +
