...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-3">
                <p class="border text-center p-2"><b>FIDSL-Ad-06-03-01254 / 22 </b></p>
            </div>
                    ...
                    <tbody>
                        @foreach ($ad_tests as $ad_test)
                            <tr>
                                ...
                                <td>{{ $ad_test->before_result }}</td>
                                <td>{{ $ad_test->after_result }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="col-sm-6 my-3">
                <span>Sign: <img src="{{ asset('photos/mr_ad01254s/' . $ad->sign) }}" alt=""
