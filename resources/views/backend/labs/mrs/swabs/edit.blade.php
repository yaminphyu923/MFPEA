            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="mt-2"><b>Swab Test Report</b></h4>
                        {{-- <a href="{{ route('swab_tests.index') }}">
                            <button type="button" class="btn btn-md btn-primary"><b>swab Analysis Test
                                    Parameter</b></button>
                        </a> --}}
                ...
                <div class="col-sm-12">
                    <div class="card bg-primary text-light">
                        ...
                        <form action="{{ route('swabs.update', $swab->id) }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" name="test_performed_date" class="form-control"
                                                    value="{{ $swab->test_performed_date }}">
                                            </div>
                                        </div>
                                    </div>
