            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Ad-06-03-01357/22</b></h4>
                    </div>

                    <form action="{{ route('ad01357s.update', $ad->id) }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">Consignee</label>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">Vessel Name</label>

                                        <div class="col-sm-8">
                                            <input type="text" name="vessel_name" class="form-control"
                                                value="{{ $ad->vessel_name }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">EORI</label>

                                        <div class="col-sm-8">
                                            <input type="text" name="eori" class="form-control"
                                                value="{{ $ad->eori }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">H.S Code</label>
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-4">Sample Taken By</label>

                                        <div class="col-sm-8">
                                            <input type="text" name="sample_taken" class="form-control"
                                                value="{{ $ad->sample_taken }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                @foreach ($ad_tests as $ad_test)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 my-0">
                                            <div class="form-group row">
                                                <label for="" class="col-sm-5">Reference Range</label>

                                                <div class="col-sm-7">
                                                    <input type="text" name="range[]" class="form-control"
                                                        autocomplete="off" value="{{ $ad_test->range }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="standard[]" class="form-control"
                                                        autocomplete="off" value="{{ $ad_test->standard }}">
                                                </div>
                                            </div>
                                        </div>
