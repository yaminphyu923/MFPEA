...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom: 10px;">
        ...
        <div class="gc-form" style="flex-grow: 1">FIDSL-Ad-06-03-00084 / 22</div>
    </div>
    ...
    <h5>From the above parameters Samonella does not include in accreditation scope.</h5>
    ...
    <div class="flex-container">
        ...
        <div class="sign" style="flex-grow: 6">
            <img src="{{ asset('photos/mr_ad00084s/' . $ad->sign) }}" alt="" style="width:100px;">
