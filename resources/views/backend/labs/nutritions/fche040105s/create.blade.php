            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/05</b></h4>
                    </div>

                    <form action="{{ route('fche040105.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="Soxhlet Extraction Method (AOAC,    )">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="aluminium" class="form-control"
                                                value="Weight of aluminium beaker (empty)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="beakerplusresidue" class="form-control"
                                                value="Weight of beaker + residue">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fat_cal" class="form-control"
                                                value="Crude Fat (%) = (wt of residue/wt of sample)*100">
                                        </div>
                                    </div>
                                </div>
