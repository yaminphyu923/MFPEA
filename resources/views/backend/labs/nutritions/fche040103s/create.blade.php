            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/03</b></h4>
                    </div>

                    <form action="{{ route('fche040103.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="naoh" class="form-control"
                                                value="Volume of 40% NaOH solution">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="receiver" class="form-control"
                                                value="Volume of receiver solution (4% Boric acid)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="n" class="form-control"
                                                value="Normality of Hydrochloric acid(N)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="t" class="form-control"
                                                value="Titration Volume of sample (T)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="b" class="form-control"
                                                value="Titration Volume of blank (B)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="f" class="form-control"
                                                value="F=conversion factor for nitrogen to protein">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="protein" class="form-control" value="Protein %">
                                        </div>
                                    </div>
                                </div>
