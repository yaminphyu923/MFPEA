...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF CRUDE FIBER
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/04</div>
    </div>
    ...
    <table class="gc-table table table-bordered">
        ...
        <tbody>
            ...
            <tr style="border-color: #F5F7FF;">
                <td>After Extraction,<br><br>{{ $che->w3 }}</td>
                <td>{{ $che->w3_test1 }}</td>
                <td>{{ $che->w3_test2 }}</td>
            </tr>

            <tr style="border-color: #F5F7FF;">
                <td>After Ashing,<br><br>{{ $che->w4 }}</td>
                <td>{{ $che->w4_test1 }}</td>
                <td>{{ $che->w4_test2 }}</td>
            </tr>
            ...
            <tr>
                <td>{{ $che->fiber_cal }}</td>
                <td>{{ $che->fiber_cal_test1 }}</td>
                <td>{{ $che->fiber_cal_test2 }}</td>
            </tr>
            ...
            <tr>
                <td>{{ $che->fiber }}</td>
                <td>{{ $che->fiber_test1 }}</td>
                <td>{{ $che->fiber_test2 }}</td>
            </tr>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/na_fche040104s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/na_fche040104s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif
