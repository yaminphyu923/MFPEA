            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-00/03</b></h4>
                    </div>

                    <form action="{{ route('fche040003.update', $fche040003->id) }}" method="POST"
                                            ...
                                            <select name="customer_id" class="form-control myselect">
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}"
                                                        @if ($customer->id == $fche040003->customer_id) selected @endif>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="received_date" class="form-control"
                                                value="{{ $fche040003->received_date }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="initiated_date" class="form-control"
                                                value="{{ $fche040003->initiated_date }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="reported_date" class="form-control"
                                                value="{{ $fche040003->reported_date }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="analysed_name" class="form-control"
                                                value="{{ $fche040003->analysed_name }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="analysed_date" class="form-control"
                                                value="{{ $fche040003->analysed_date }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 my-0">
