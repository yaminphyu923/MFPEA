...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF CRUDE FAT (BY DIGESTION)</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/06</b></p>
            </div>
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-borderless table-stripped">
                        ...
                        <tr>
                            <td>Method</td>
                            <td>: {{ $che->acid_method != null ? $che->acid_method : '' }}
                                <br>
                                </br>
                                : {{ $che->alkali_method != null ? $che->alkali_method : '' }}
                            </td>
                        </tr>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>Pretreatment with Ammonia</td>
                            <td></td>
                            <td></td>
                        </tr>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->nh4oh }}</td>
                            <td>{{ $che->nh4oh_test1 }}</td>
                            <td>{{ $che->nh4oh_test2 }}</td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->alcohol }}</td>
                            <td>{{ $che->alcohol_test1 }}</td>
                            <td>{{ $che->alcohol_test2 }}</td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>Pretreatment with Acid</td>
                            <td></td>
                            <td></td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->first_alcohol }}</td>
                            <td>{{ $che->first_alcohol_test1 }}</td>
                            <td>{{ $che->first_alcohol_test2 }}</td>
                        </tr>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->second_alcohol }}</td>
                            <td>{{ $che->second_alcohol_test1 }}</td>
                            <td>{{ $che->second_alcohol_test2 }}</td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>Extraction with pet ether</td>
                            <td></td>
                            <td></td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/na_fche040106s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/na_fche040106s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
