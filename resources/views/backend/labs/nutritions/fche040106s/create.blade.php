            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/06</b></h4>
                    </div>

                    <form action="{{ route('fche040106.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="acid_method" class="form-control"
                                                value="Acid Hydrolysis Method(AOAC,   )">
                                        </div>

                                        <div class="col-sm-5">
                                            <input type="text" name="alkali_method" class="form-control"
                                                value="Alkali Hydrolysis Method(AOAC,   )">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="second_alcohol" class="form-control"
                                                value="Volume of second alcohol">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fat" class="form-control" value="Fat %">
                                        </div>
                                    </div>
                                </div>
