...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-00/01</div>
    </div>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->analyzed_sign != null)
                <img src="{{ asset('photos/na_fche040001s/analyzed_sign/' . $che->analyzed_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif

            <h4>: <b>{{ $che->analyzed_date != null ? date('d-M-Y', strtotime($che->analyzed_date)) : '' }}</b></h4>
            <h4>: <b>{{ $che->analyzed_by != null ? $che->analyzed_by : '' }}</b></h4>
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/na_fche040001s/analyzed_sign/' . $che->checked_sign) }}" alt=""
                    style="width:100px;">
            @else
                <span>____</span>
            @endif
            ...
            <h4>: <b>{{ $che->checked_by != null ? $che->checked_by : '' }}</b></h4>
