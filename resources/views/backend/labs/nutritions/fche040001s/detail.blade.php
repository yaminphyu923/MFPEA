...
@section('fche040001-active', 'active')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-00/01</b></p>
            </div>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analyzed_sign != null)
                        <img src="{{ asset('photos/na_fche040001s/analyzed_sign/' . $che->analyzed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/na_fche040001s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
