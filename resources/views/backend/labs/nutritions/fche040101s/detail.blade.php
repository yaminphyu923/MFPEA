...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF MOISTURE</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/01</b></p>
            </div>
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-borderless table-stripped">
                        ...
                        <tr>
                            <td>Method</td>
                            <td>: {{ $che->air_method != null ? $che->air_method : '' }}
                                <br>
                                <br>
                                : {{ $che->vaccum_method != null ? $che->vaccum_method : '' }}
                            </td>
                        </tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->dish }}</td>
                            <td>{{ $che->dish_test1 }}</td>
                            <td>{{ $che->dish_test2 }}</td>
                        </tr>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>After dying,<br><br>{{ $che->dishplussample }}</td>
                            <td>{{ $che->dishplussample_test1 }}</td>
                            <td>{{ $che->dishplussample_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/na_fche040101s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/na_fche040101s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
