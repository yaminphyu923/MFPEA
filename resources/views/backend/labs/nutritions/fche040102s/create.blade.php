            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/02</b></h4>
                    </div>

                    <form action="{{ route('fche040102.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
