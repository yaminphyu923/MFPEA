...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORKSHEET FOR Escherichia coli (E.cqll) COUNT
        </div>
        <div class="gc-form" style="flex-grow: 1">F-M03-01-01</div>
    </div>
    ...
    <table class="gc-table table table-bordered">
        <thead>
            <tr>
                <th colspan="3" style="text-align: center;">Escherichia coli (E.cqll) COUNT</th>
            </tr>
            <tr>
                <th>Dilution</th>
                <th>Plate 1</th>
