...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORKSHEET FOR Staphylococcus aureus(S.aureus) COUNT</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>F-M04-01-01</b></p>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <p style="display: inline-block;">Reference Method</p>
                    <p style="display: inline-block;">: {{ $m->reference_method != null ? $m->reference_method : '' }}</p>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th colspan="3">Staphylococcus aureus(S.aureus) COUNT</th>
                        </tr>
                        <tr>
                            <th>Dilution</th>
                            <th>Plate 1</th>
