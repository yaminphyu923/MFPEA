            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-03-M-05</b></h4>
                    </div>

                    <form action="{{ route('f03m05.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="Culture Media Method (AOAC-2000.06)">
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $(".test").append(
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Selective Agar </label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="agar[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Slant (TSI) </label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="tsi_slant[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Butt (TSI) </label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="tsi_butt[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">H2S (TSI)</label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="tsi_h2s[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Gas (TSI)</label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="tsi_gas[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Slant (LI) </label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="li_slant[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Butt (LI) </label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="li_butt[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-4">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">H2S (LI)</label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="li_h2s[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<div class="col-sm-3">' +
                        '<div class="form-group row">' +
                        '<label for="" class="col-sm-6 text-md-end">Gas (LI)</label>' +

                        '<div class="col-sm-6">' +
                        '<input type="text" name="li_gas[]" class="form-control">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
