        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('ad01288.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="test">
                                <div class="row test-row">
                                    ...
                                    <div class="col-sm-3 my-0">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-6">Limit of Detection</label>

                                            <div class="col-sm-6">
                                                <input type="text" name="detection[]" class="form-control">
                                            </div>
                                        </div>
                                    </div>
        ...
        function add() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $(".test").append(
                        '<div class="mt-1 test-row row row_' + row + '">' +
                        // '<div class="col-sm-4">' +
                        // '<div class="form-group row">' +
