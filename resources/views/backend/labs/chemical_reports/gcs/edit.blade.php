            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        {{-- <a href="{{ route('gc_tests.index') }}">
                            <button type="button" class="btn btn-md btn-primary"><b>gc Analysis Test
                                    Parameter</b></button>
                        </a> --}}
                ...
                <div class="col-sm-12">
                    <div class="card bg-primary text-light">
                        ...
                        <form action="{{ route('gcs.update', $gc->id) }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="myristic_14_0_result"
                                                        class="form-control" value="{{ $gc->myristic_14_0_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="myristoleic_14_1_result"
                                                        class="form-control" value="{{ $gc->myristoleic_14_1_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="palmitic_16_0_result"
                                                        class="form-control" value="{{ $gc->palmitic_16_0_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="palmitoleic_16_1_result"
                                                        class="form-control" value="{{ $gc->palmitoleic_16_1_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="oleictrans_18_1_result"
                                                        class="form-control" value="{{ $gc->oleictrans_18_1_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="linoleictrans_18_2_result"
                                                        class="form-control"
                                                        value="{{ $gc->linoleictrans_18_2_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="linoleic_18_2_result"
                                                        class="form-control" value="{{ $gc->linoleic_18_2_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="linoleic_18_3_result"
                                                        class="form-control" value="{{ $gc->linoleic_18_3_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="arachidic_20_0_result"
                                                        class="form-control" value="{{ $gc->arachidic_20_0_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="paullinic_20_1_result"
                                                        class="form-control" value="{{ $gc->paullinic_20_1_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="arachidonic_20_4_result"
                                                        class="form-control" value="{{ $gc->arachidonic_20_4_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" name="lignoceric_24_0_result"
                                                        class="form-control" value="{{ $gc->lignoceric_24_0_result }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
