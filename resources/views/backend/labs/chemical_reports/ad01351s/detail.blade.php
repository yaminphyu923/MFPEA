...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-3">
                <p class="border text-center p-2"><b>FIDSL-Ad-06-03-01351 / 22 </b></p>
            </div>
            ...
            <div class="col-sm-9">
                <ul class="list-unstyled">
                    ...
                    <li>: {{ $ad->code_no != null ? $ad->code_no : '-' }}</li>
                    <li>: {{ $ad->mfd != null ? date('d-M-Y', strtotime($ad->mfd)) : '-' }}</li>
                    <li>: {{ $ad->exp != null ? date('d-M-Y', strtotime($ad->exp)) : '-' }}</li>
                    <li>: {{ $ad->can_size != null ? $ad->can_size : '-' }}</li>
                    <li>:
                        {{ $ad->test_performed_date != null ? date('d-M-Y', strtotime($ad->test_performed_date)) : '-' }}
                    </li>
            ...
            <div class="col-sm-6 my-3">
                <span>Sign: <img src="{{ asset('photos/cr_ad01351s/' . $ad->sign) }}" alt=""
                        style="width:100px;"></span>
                <h6>{{ $ad->checked_name }}</b></h6>
            </div>
