...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom: 10px;">
        ...
        <div class="gc-form" style="flex-grow: 1">FIDSL-Ad-06-03-01351 / 22</div>
    </div>
    ...
    <div class="flex-box">
        <table class="table table-stripped">
            ...
            <tr>
                <td>7.Code No</td>
                <td>: {{ $ad->code_no != null ? $ad->code_no : '' }}</td>
            </tr>

            <tr>
                <td>8.MFD</td>
                <td>: {{ $ad->mfd != null ? date('d-M-Y', strtotime($ad->mfd)) : '' }}
                </td>
            </tr>

            <tr>
                <td>9.Exp</td>
                <td>: {{ $ad->exp != null ? date('d-M-Y', strtotime($ad->exp)) : '' }}
                </td>
            </tr>

            <tr>
                <td>10.Can Size</td>
                <td>: {{ $ad->can_size != null ? $ad->can_size : '' }}</td>
            </tr>

            <tr>
                <td>11.Test Performed Date</td>
    ...
    <div class="flex-container">
        ...
        <div class="sign" style="flex-grow: 6">
            <img src="{{ asset('photos/cr_ad01351s/' . $ad->sign) }}" alt="" style="width:100px;">
