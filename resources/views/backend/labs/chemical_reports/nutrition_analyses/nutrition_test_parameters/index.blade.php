        ...
        <div class="col-sm-12">
            <div class="card mb-3 card-button">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="mt-2"><b>Nutrition Analysis Test Parameter</small></b></h4>
                    <div class="justify-content-end">
                        ...
                        <div class="modal fade" id="member" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog">
                                <form action="{{ route('nutrition_tests.store') }}" method="POST">
                                    @csrf
                    ...
                    <tbody>
                        @foreach ($nutrition_tests as $test)
                            <tr>
                                ...
                                <td>{{ $test->name }}</td>
                                <td>
                                    <form action="{{ route('nutrition_tests.update', $test->id) }}" method="POST"
                                        autocomplete="off">
                                        @csrf
                                        {{ method_field('PUT') }}
                                ...
                                <td>
                                    <form action="{{ route('nutrition_tests.destroy', $test->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
