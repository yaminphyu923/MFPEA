            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-00/29</b></h4>
                    </div>

                    <form action="{{ route('fche040029.update', $che->id) }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-5">1<sup>st</sup></label>

                                        <div class="col-sm-7">
                                            <input type="text" name="sample_weight_1" class="form-control"
                                                value="{{ $che->sample_weight_1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-5">2<sup>nd</sup></label>

                                        <div class="col-sm-7">
                                            <input type="text" name="sample_weight_2" class="form-control"
                                                value="{{ $che->sample_weight_2 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="boron_heating_time_1" class="form-control"
                                                value="{{ $che->boron_heating_time_1 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="boron_heating_time_2" class="form-control"
                                                value="{{ $che->boron_heating_time_2 }}">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function add() {
            ...
            $(".test").append(
                ...
                '<div class="col-sm-3">' +
                '<div class="form-group row">' +
                '<label for="" class="col-sm-6 text-md-end">1<sup>st</sup> </label>' +
                ...
                '<div class="col-sm-3">' +
                '<div class="form-group row">' +
                '<label for="" class="col-sm-6 text-md-end">2<sup>nd</sup> </label>' +
