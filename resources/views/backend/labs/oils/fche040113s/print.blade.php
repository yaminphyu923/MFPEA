...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:12px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF ACID VALUE
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/13</div>
    </div>
    ...
    <table class="gc-table table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $che->acid_cal }}</td>
                <td>{{ $che->acid_cal_test1 }}</td>
                <td>{{ $che->acid_cal_test2 }}</td>
            </tr>
            ...
            <tr>
                <td>{{ $che->acid }}</td>
                <td>{{ $che->acid_test1 }}</td>
                <td>{{ $che->acid_test2 }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:12px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/oil_fche040113s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                    style="width:120px;">
            @else
                <span>____</span>
            @endif
        ...
        <div style="flex-grow: 2;margin-top:12px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/oil_fche040113s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:120px;">
            @else
                <span>____</span>
            @endif
