...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:11px;">
        ...
        <div class="gc-form" style="flex-grow: 1">FIDSL-04-Che/11</div>
    </div>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:11px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/oil_f04che11s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                    style="width:110px;">
            @else
                <span>____</span>
            @endif
        ...
        <div style="flex-grow: 2;margin-top:11px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/oil_f04che11s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:110px;">
            @else
                <span>____</span>
            @endif
