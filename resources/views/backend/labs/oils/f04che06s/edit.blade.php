            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-04-Che/06</b></h4>
                    </div>

                    <form action="{{ route('f04che06.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="test">
                                @foreach ($che_tests as $che_test)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 my-0">
                                            <div class="form-group row">
                                                <label for="" class="col-sm-8">Data</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="analyzed_date" class="form-control"
                                                autocomplete="off" value="{{ $che->analyzed_date }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="analyzed_by" class="form-control"
                                                autocomplete="off" value="{{ $che->analyzed_by }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="checked_by" class="form-control"
                                                autocomplete="off" value="{{ $che->checked_by }}">
                                        </div>
                                    </div>
                                </div>
