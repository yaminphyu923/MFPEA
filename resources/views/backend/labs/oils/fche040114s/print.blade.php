...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:12px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF PEROXIDE VALUE
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/14</div>
    </div>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:12px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/oil_fche040114s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                    style="width:120px;">
            @else
                <span>____</span>
            @endif
