            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/10</b></h4>
                    </div>

                    <form action="{{ route('fche040110.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_sample" class="form-control"
                                                value="Volume of HCL solution (sample-S)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl_blank" class="form-control"
                                                value="Volume of HCL solution (blank-B)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="hcl" class="form-control"
                                                value="Exact normality of HCL (N)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sap_cal" class="form-control"
                                                value="Saponification value = (56.1*N*(B-S))/wt of sample">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sap" class="form-control"
                                                value="Saponification value (mg KOH/g oil)">
                                        </div>
                                    </div>
                                </div>
