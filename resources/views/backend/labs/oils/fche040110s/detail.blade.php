...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF SAPONIFICATION VALUE</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/10</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $che->hcl_sample }}</td>
                            <td>{{ $che->hcl_sample_test1 }}</td>
                            <td>{{ $che->hcl_sample_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->hcl_blank }}</td>
                            <td>{{ $che->hcl_blank_test1 }}</td>
                            <td>{{ $che->hcl_blank_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->sap_cal }}</td>
                            <td>{{ $che->sap_cal_test1 }}</td>
                            <td>{{ $che->sap_cal_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/oil_fche040110s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/oil_fche040110s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
