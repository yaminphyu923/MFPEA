...
@section('fche040115-active', 'active')
...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF MOISTURE (VOLATILE MATTER)</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/15</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $che->container }}</td>
                            <td>{{ $che->container_test1 }}</td>
                            <td>{{ $che->container_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3"><b>After Drying,</b></td>
                        </tr>

                        <tr>
                            <td>{{ $che->sample_container }}</td>
                            <td>{{ $che->sample_container_test1 }}</td>
                            <td>{{ $che->sample_container_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->moisture_cal }}</td>
                            <td>{{ $che->moisture_cal_test1 }}</td>
                            <td>{{ $che->moisture_cal_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->moisture }}</td>
                            <td>{{ $che->moisture_test1 }}</td>
                            <td>{{ $che->moisture_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/oil_fche040115s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/oil_fche040115s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:120px;">
                    @else
                        <span>____</span>
                    @endif
