...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF REFRACTIVE INDEX</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/09</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->brix_one }}</td>
                            <td>{{ $che->brix_one_test1 }}</td>
                            <td>{{ $che->brix_one_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->index_one }}</td>
                            <td>{{ $che->index_one_test1 }}</td>
                            <td>{{ $che->index_one_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->index_two }}</td>
                            <td>{{ $che->index_two_test1 }}</td>
                            <td>{{ $che->index_two_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->brix_two }}</td>
                            <td>{{ $che->brix_two_test1 }}</td>
                            <td>{{ $che->brix_two_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/oil_fche040109s/analysed_sign/' . $che->analysed_sign) }}"
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/oil_fche040109s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
