...
@section('fche040109-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-01/09</b></h4>
                    </div>

                    <form action="{{ route('fche040109.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3">1st Reading</label>

                                        <div class="col-sm-9">
                                            <input type="text" name="temperature_test1" class="form-control"
                                                value="{{ $che->temperature_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3">2nd Reading</label>

                                        <div class="col-sm-9">
                                            <input type="text" name="temperature_test2" class="form-control"
                                                value="{{ $che->temperature_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_one" class="form-control"
                                                value="{{ $che->brix_one }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_one_test1" class="form-control"
                                                value="{{ $che->brix_one_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_one_test2" class="form-control"
                                                value="{{ $che->brix_one_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_one" class="form-control"
                                                value="{{ $che->index_one }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_one_test1" class="form-control"
                                                value="{{ $che->index_one_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_one_test2" class="form-control"
                                                value="{{ $che->index_one_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_two" class="form-control"
                                                value="{{ $che->index_two }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_two_test1" class="form-control"
                                                value="{{ $che->index_two_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="index_two_test2" class="form-control"
                                                value="{{ $che->index_two_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_two" class="form-control"
                                                value="{{ $che->brix_two }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_two_test1" class="form-control"
                                                value="{{ $che->brix_two_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="brix_two_test2" class="form-control"
                                                value="{{ $che->brix_two_test2 }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
