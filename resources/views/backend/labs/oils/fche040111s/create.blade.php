            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/11</b></h4>
                    </div>

                    <form action="{{ route('fche040111.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="koh" class="form-control"
                                                value="Volume of alcoholic KOH solution">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="petro" class="form-control"
                                                value="Volume of petroleum ether for extraction">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ethanol" class="form-control"
                                                value="Volume of 50% ethanol for washing">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="flask_residue" class="form-control"
                                                value="Weight of flask and residue">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="unsap_cal" class="form-control"
                                                value="Unsaponifiable matter (%) = (wt of residue * 100) / wt of sample">
                                        </div>
                                    </div>
                                </div>
