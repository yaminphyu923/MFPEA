            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/47</b></h4>
                    </div>

                    <form action="{{ route('che040047.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method_id" class="form-control"
                                                value="Atomic Absorption Spectrophotometer (AAS-MVU)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="hg_1" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="hg_2" class="form-control">
                                        </div>
                                    </div>
                                </div>
