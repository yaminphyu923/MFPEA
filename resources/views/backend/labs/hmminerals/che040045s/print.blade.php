...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF LEAD (PB)
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/45</div>
    </div>
    ...
    <div class="flex-container">
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/hmm_che040045s/analysed_sign/' . $che->analysed_sign) }}" alt=""
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/hmm_che040045s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:100px;height:44px;">
            @else
                <span>____</span>
            @endif
