            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-end">
                        ...
                        {{-- <a href="{{ route('car0441-test.index') }}">
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-01/44</b></h4>
                    </div>

                    <form action="{{ route('che040044.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="cu_1" class="form-control"
                                                value="{{ $che->cu_1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="cu_2" class="form-control"
                                                value="{{ $che->cu_2 }}">
                                        </div>
                                    </div>
                                </div>
