...
@section('content')
    ...
    <div class="flex-container" style="margin-bottom:10px;">
        ...
        <div class="analysis" style="flex-grow: 15">
            WORK SHEET FOR DETERMINATION OF COPPER (CU)
        </div>
        <div class="gc-form" style="flex-grow: 1">FIDSL-Che-04-01/44</div>
    </div>
    ...
    <div class="flex-container">
        <div style="flex-grow: 2">
            ...
            <h4 style="height: 44px;">Analysed by Sign</h4>
            <h4>Date</h4>
            <h4>Name</h4>
        </div>
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->analysed_sign != null)
                <img src="{{ asset('photos/hmm_che040044s/analysed_sign/' . $che->analysed_sign) }}" alt=""
        ...
        <div style="flex-grow: 2">
            ...
            <h4 style="height: 44px;">Checked by Sign</h4>
            <h4>Date</h4>
            <h4>Name</h4>
        </div>
        ...
        <div style="flex-grow: 2;margin-top:10px;">
            ...
            : @if ($che->checked_sign != null)
                <img src="{{ asset('photos/hmm_che040044s/checked_sign/' . $che->checked_sign) }}" alt=""
                    style="width:100px;height:44px;">
            @else
                <span>____</span>
            @endif
