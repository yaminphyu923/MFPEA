            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/46</b></h4>
                    </div>

                    <form action="{{ route('che040146.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="mg_1" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="mg_2" class="form-control">
                                        </div>
                                    </div>
                                </div>
