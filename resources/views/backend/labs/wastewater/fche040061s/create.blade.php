            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/61</b></h4>
                    </div>

                    <form action="{{ route('fche040061.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="HACH-UV-Vis Spectrophotometer (DPD Method)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="chlorine_cal" class="form-control"
                                                value="Chlorine (mg/L) = instrument reading * dilution factor">
                                        </div>
                                    </div>
                                </div>
