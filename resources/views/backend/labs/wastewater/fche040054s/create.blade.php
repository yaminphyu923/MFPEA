            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/54</b></h4>
                    </div>

                    <form action="{{ route('fche040054.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="water" class="form-control"
                                                value="Deionized water (Blank) ml">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="cod_cal" class="form-control"
                                                value="COD mg/L = instrument reading * dilution factor">
                                        </div>
                                    </div>
                                </div>
