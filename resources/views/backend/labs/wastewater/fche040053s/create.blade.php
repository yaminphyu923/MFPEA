            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/53</b></h4>
                    </div>

                    <form action="{{ route('fche040053.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="BOD Trak(TM) II Apparatus (Respirometric Method)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pillow" class="form-control"
                                                value="Nos of Nutrient BUffer Pillows">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pellet" class="form-control"
                                                value="Nos of Potassium Hydroxide Pellets">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="bod_cal" class="form-control"
                                                value="BOD mg/L = instrument reading * dilution factor">
                                        </div>
                                    </div>
                                </div>
