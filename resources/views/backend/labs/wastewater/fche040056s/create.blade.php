            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/56</b></h4>
                    </div>

                    <form action="{{ route('fche040056.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="potassium" class="form-control"
                                                value="Potassium Persulfate Powder Pillow">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="temperature" class="form-control"
                                                value="DRB200 Reactor Temperature">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reactor_time" class="form-control"
                                                value="Reaction Times (into Reactor)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sodium" class="form-control"
                                                value="1.54 N Sodium Hydroxide standard solution (ml)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phos" class="form-control"
                                                value="Total Phosphorus (mg/L) = instrument reading * dilution factor">
                                        </div>
                                    </div>
                                </div>
