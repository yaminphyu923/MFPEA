            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-00/56</b></h4>
                    </div>

                    <form action="{{ route('fche040056.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="potassium_test1" class="form-control"
                                                value="{{ $che->potassium_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="potassium_test2" class="form-control"
                                                value="{{ $che->potassium_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reactor_time" class="form-control"
                                                value="{{ $che->reactor_time }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reactor_time_test1" class="form-control"
                                                value="{{ $che->reactor_time_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reactor_time_test2" class="form-control"
                                                value="{{ $che->reactor_time_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phosver" class="form-control"
                                                value="{{ $che->phosver }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phosver_test1" class="form-control"
                                                value="{{ $che->phosver_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phosver_test2" class="form-control"
                                                value="{{ $che->phosver_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phos" class="form-control"
                                                value="{{ $che->phos }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phos_test1" class="form-control"
                                                value="{{ $che->phos_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phos_test2" class="form-control"
                                                value="{{ $che->phos_test2 }}">
                                        </div>
                                    </div>
                                </div>
