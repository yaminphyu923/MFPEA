...
@section('fche040060-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-00/60</b></h4>
                    </div>

                    <form action="{{ route('fche040060.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="HACH-UV-VIS Spectrophotometer (Methylene Blue Method), Method 10294/TNT 861">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide" class="form-control"
                                                value="Sulfide Range (mg/L)">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide_test1" class="form-control"
                                                value="0.1 - 2.0 mg/L">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide_test2" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4 my-0">
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide_cal" class="form-control"
                                                value="Sulfide (mg/L) = instrument reading * dilution factor">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide_cal_test1" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sulfide_cal_test2" class="form-control">
                                        </div>
                                    </div>
                                </div>
