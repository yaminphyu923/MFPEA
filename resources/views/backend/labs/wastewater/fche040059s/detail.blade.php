...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF LEAD</b>
                </h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-00/59</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $che->lead_range }}</td>
                            <td>{{ $che->lead_range_test1 }}</td>
                            <td>{{ $che->lead_range_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->reagenta }}</td>
                            <td>{{ $che->reagenta_test1 }}</td>
                            <td>{{ $che->reagenta_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->solutionb }}</td>
                            <td>{{ $che->solutionb_test1 }}</td>
                            <td>{{ $che->solutionb_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->treated }}</td>
                            <td>{{ $che->treated_test1 }}</td>
                            <td>{{ $che->treated_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->reaction_time2 }}</td>
                            <td>{{ $che->reaction_time2_test1 }}</td>
                            <td>{{ $che->reaction_time2_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->read }}</td>
                            <td>{{ $che->read_test1 }}</td>
                            <td>{{ $che->read_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->solutionc }}</td>
                            <td>{{ $che->solutionc_test1 }}</td>
                            <td>{{ $che->solutionc_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->reaction_time3 }}</td>
                            <td>{{ $che->reaction_time3_test1 }}</td>
                            <td>{{ $che->reaction_time3_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->lead }}</td>
                            <td>{{ $che->lead_test1 }}</td>
                            <td>{{ $che->lead_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/ww_fche040059s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/ww_fche040059s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
