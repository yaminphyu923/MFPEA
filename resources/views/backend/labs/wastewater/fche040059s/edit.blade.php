            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-00/59</b></h4>
                    </div>

                    <form action="{{ route('fche040059.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reaction_time2_test1" class="form-control"
                                                value="{{ $che->reaction_time2_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reaction_time2_test2" class="form-control"
                                                value="{{ $che->reaction_time2_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="read_test1" class="form-control"
                                                value="{{ $che->read_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reaction_time3_test1" class="form-control"
                                                value="{{ $che->reaction_time3_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="reaction_time3_test2" class="form-control"
                                                value="{{ $che->reaction_time3_test2 }}">
                                        </div>
                                    </div>
                                </div>
