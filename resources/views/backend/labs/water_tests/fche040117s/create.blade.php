            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/17</b></h4>
                    </div>

                    <form action="{{ route('fche040117.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control" value="AOAC-">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="total_cal" class="form-control"
                                                value="Total solids = ((A*1000)/100)*1000">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="dissolved_cal" class="form-control"
                                                value="Dissolved solids = ((B*1000)/100)*1000">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="suspended_cal" class="form-control"
                                                value="Suspended solids = Total solids - Dissolved solids">
                                        </div>
                                    </div>
                                </div>
