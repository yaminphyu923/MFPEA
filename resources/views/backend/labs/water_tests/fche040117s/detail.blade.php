...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            ...
            <div class="col-sm-12">
                <h5 class="text-center"><b>WORK SHEET FOR DETERMINATION OF TOTAL SOLIDS, DISSOLVED SOLIDS, SUSPENDED
                        SOLIDS</b></h5>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <p class="border text-center p-2"><b>FIDSL-Che-04-01/17</b></p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->total_cal }}</td>
                            <td>{{ $che->total_cal_test1 }}</td>
                            <td>{{ $che->total_cal_test2 }}</td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->dissolved_cal }}</td>
                            <td>{{ $che->dissolved_cal_test1 }}</td>
                            <td>{{ $che->dissolved_cal_test2 }}</td>
                        </tr>

                        <tr style="border-color: #F5F7FF;">
                            <td>{{ $che->suspended_cal }}</td>
                            <td>{{ $che->suspended_cal_test1 }}</td>
                            <td>{{ $che->suspended_cal_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->total }}</td>
                            <td>{{ $che->total_test1 }}</td>
                            <td>{{ $che->total_test2 }}</td>
                        </tr>

                        <tr>
                            <td>{{ $che->dissolved }}</td>
                            <td>{{ $che->dissolved_test1 }}</td>
                            <td>{{ $che->dissolved_test2 }}</td>
                        </tr>
                        ...
                        <tr>
                            <td>{{ $che->suspended }}</td>
                            <td>{{ $che->suspended_test1 }}</td>
                            <td>{{ $che->suspended_test2 }}</td>
                        </tr>
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Analysed by Sign:
                    @if ($che->analysed_sign != null)
                        <img src="{{ asset('photos/wt_fche040117s/analysed_sign/' . $che->analysed_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
            ...
            <div class="col-sm-6 my-3">
                ...
                <span>Checked by Sign:
                    @if ($che->checked_sign != null)
                        <img src="{{ asset('photos/wt_fche040117s/checked_sign/' . $che->checked_sign) }}" alt=""
                            style="width:100px;">
                    @else
                        <span>____</span>
                    @endif
