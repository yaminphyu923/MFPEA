...
@section('fche040119-active', 'active')
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>Edit FIDSL-Che-04-01/19</b></h4>
                    </div>

                    <form action="{{ route('fche040119.update', $che->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="calibration_test1" class="form-control"
                                                value="{{ $che->calibration_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="calibration_test2" class="form-control"
                                                value="{{ $che->calibration_test2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="conductivity_test1" class="form-control"
                                                value="{{ $che->conductivity_test1 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="conductivity_test2" class="form-control"
                                                value="{{ $che->conductivity_test2 }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
