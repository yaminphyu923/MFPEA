            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/16</b></h4>
                    </div>

                    <form action="{{ route('fche040116.store') }}" method="POST" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="method" class="form-control"
                                                value="EDTA Titrimetric method (AOAC-       )">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="distilled" class="form-control"
                                                value="Volume of Distilled Water">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="buffer" class="form-control"
                                                value="Volume of Buffer solution">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="indicator" class="form-control"
                                                value="Weight of indicator powder">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="t" class="form-control"
                                                value="Volume of EDTA standard solution (T)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="b" class="form-control"
                                                value="Mg CaCO3 to 1ml EDTA std solution (B)">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="edta" class="form-control"
                                                value="Hardness (EDTA) as mg CaCO3/L = T*B*1000/volume of sample">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ca" class="form-control"
                                                value="Ca Hardness = Total Hardness * 0.7147">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mg" class="form-control"
                                                value="Mg Hardness = Total Hardness - Ca Hardness">
                                        </div>
                                    </div>
                                </div>
