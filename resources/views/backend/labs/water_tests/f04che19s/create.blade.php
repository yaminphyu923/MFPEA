            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-04-Che/19</b></h4>
                    </div>

                    <form action="{{ route('f04che19.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="test">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 my-0">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-5">1st Reading</label>
                                    ...
                                    <div class="col-sm-3 my-0">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-5">2nd Reading</label>
    ...
    <script>
        ...
        function add() {
            ...
            $(".test").append(
                ...
                '<div class="col-sm-3">' +
                '<div class="form-group row">' +
                '<label for="" class="col-sm-6 text-md-end">1st Reading</label>' +
                ...
                '<div class="col-sm-3">' +
                '<div class="form-group row">' +
                '<label for="" class="col-sm-6 text-md-end">2nd Reading</label>' +
