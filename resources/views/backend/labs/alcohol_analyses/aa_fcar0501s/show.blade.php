            ...
            <div class="col-sm-12">
                <div class="card mb-3 card-button">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('aa_fcar0501.create') }}">
                            ...
                            @foreach ($fches as $fche)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-start">
                                        <a href="{{ route('aa_fcar0501.show', $fche->id) }}"><button type="button"
                                                class="btn btn-sm btn-primary py-2"><i class="fas fa-eye"></i>
                                                Detail</button></a>
                                        <a href="{{ route('aa_fcar0501.print', $fche->id) }}"><button type="button"
                                                class="btn btn-sm btn-success py-2"><i class="fas fa-print"></i>
                                                Print</button></a>
                                        <a href="{{ route('aa_fcar0501.edit', $fche->id) }}"><button type="button"
                                                class="btn btn-sm btn-warning py-2"><i class="fas fa-edit"></i>
                                                Edit</button></a>
                                        <form action="{{ route('aa_fcar0501.destroy', $fche->id) }}" method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
