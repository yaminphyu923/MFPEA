            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Che-04-01/47 Finance</b></h4>
                    </div>

                    <form action="{{ route('che040047-finance.update', $che040047_finance->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="voucher_2" class="form-control"
                                                value="{{ $che040047_finance->voucher_2 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="amount_2" class="form-control"
                                                value="{{ $che040047_finance->amount_2 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="date_2" class="form-control"
                                                value="{{ $che040047_finance->date_2 }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark_2" id="" cols="30" rows="1" class="form-control">{{ $che040047_finance->remark_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="test_type_2" id="" cols="30" rows="1" class="form-control">{{ $che040047_finance->test_type_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
