                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="voucher" class="form-control"
                                                value="{{ $che040050_finance->voucher }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="amount" class="form-control"
                                                value="{{ $che040050_finance->amount }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark" id="" cols="30" rows="1" class="form-control">{{ $che040050_finance->remark }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="test_type" id="" cols="30" rows="1" class="form-control">{{ $che040050_finance->test_type }}</textarea>
                                        </div>
                                    </div>
                                </div>
