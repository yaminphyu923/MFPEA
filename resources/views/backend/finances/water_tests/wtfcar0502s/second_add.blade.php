        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    ...
                    <form action="{{ route('wtfcar0502-finance.update', $wtfcar0502_finance->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="voucher_2" class="form-control"
                                                value="{{ $wtfcar0502_finance->voucher_2 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="amount_2" class="form-control"
                                                value="{{ $wtfcar0502_finance->amount_2 }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="date_2" class="form-control"
                                                value="{{ $wtfcar0502_finance->date_2 }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark_2" id="" cols="30" rows="1" class="form-control">{{ $wtfcar0502_finance->remark_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="test_type_2" id="" cols="30" rows="1" class="form-control">{{ $wtfcar0502_finance->test_type_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
