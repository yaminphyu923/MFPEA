            ...
            <div class="col-sm-12">
                <div class="card btn-theme text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-Ad-02-01 Finance</b></h4>
                    </div>

                    <form action="{{ route('updateAd0201', $ad_finance->id) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark" id="" cols="30" rows="1" class="form-control">{{ $ad_finance->remark }}</textarea>
                                        </div>
                                    </div>
                                </div>
