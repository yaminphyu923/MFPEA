            ...
            <div class="col-sm-12">
                <div class="card bg-primary text-light">
                    <div class="card-header">
                        <h4 class="text-center py-2"><b>FIDSL-03-M-05 Finance</b></h4>
                    </div>

                    <form action="{{ route('f03m05-finance.update', $f03m05_finance->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="voucher_2" class="form-control"
                                                value="{{ $f03m05_finance->voucher_2 }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark_2" id="" cols="30" rows="1" class="form-control">{{ $f03m05_finance->remark_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="test_type_2" id="" cols="30" rows="1" class="form-control">{{ $f03m05_finance->test_type_2 }}</textarea>
                                        </div>
                                    </div>
                                </div>
