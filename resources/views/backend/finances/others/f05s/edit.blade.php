                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark" id="" cols="30" rows="1" class="form-control">{{ $f05_finance->remark }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-11 my-0">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="test_type" id="" cols="30" rows="1" class="form-control">{{ $f05_finance->test_type }}</textarea>
                                        </div>
                                    </div>
                                </div>
