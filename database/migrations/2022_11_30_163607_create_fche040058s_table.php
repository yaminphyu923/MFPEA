...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fche040058s', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('phenol')->nullable();
            $table->text('phenol_test1')->nullable();
            $table->text('phenol_test2')->nullable();
            ...
            $table->text('phenol_cal')->nullable();
            $table->text('phenol_cal_test1')->nullable();
            $table->text('phenol_cal_test2')->nullable();
    ...
    {
        Schema::dropIfExists('fche040058s');
    }
};
