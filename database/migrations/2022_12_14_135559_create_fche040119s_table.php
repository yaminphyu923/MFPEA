...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fche040119s', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('conductivity_test1')->nullable();
            $table->text('conductivity_test2')->nullable();
    ...
    {
        Schema::dropIfExists('fche040119s');
    }
};
