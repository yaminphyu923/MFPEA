...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fche040054s', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('cod_test1')->nullable();
            $table->text('cod_test2')->nullable();
            ...
            $table->text('reactor')->nullable();
            $table->text('reactor_test1')->nullable();
            $table->text('reactor_test2')->nullable();
            ...
            $table->text('cod_cal')->nullable();
            $table->text('cod_cal_test1')->nullable();
            $table->text('cod_cal_test2')->nullable();
    ...
    {
        Schema::dropIfExists('fche040054s');
    }
};
