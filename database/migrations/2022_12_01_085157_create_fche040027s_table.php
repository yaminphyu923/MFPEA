...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fche040027s', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('cruplusresidue')->nullable();
            $table->text('cruplusresidue_test1')->nullable();
            $table->text('cruplusresidue_test2')->nullable();
            ...
            $table->text('ash_cal2')->nullable();
            $table->text('ash_cal2_test1')->nullable();
            $table->text('ash_cal2_test2')->nullable();
    ...
    {
        Schema::dropIfExists('fche040027s');
    }
};
