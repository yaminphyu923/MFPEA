...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fche040056s', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('reactor_time')->nullable();
            $table->text('reactor_time_test1')->nullable();
            $table->text('reactor_time_test2')->nullable();
            $table->text('sodium')->nullable();
            $table->text('sodium_test1')->nullable();
            $table->text('sodium_test2')->nullable();
            $table->text('phosver')->nullable();
            $table->text('phosver_test1')->nullable();
            $table->text('phosver_test2')->nullable();
            ...
            $table->text('phos')->nullable();
            $table->text('phos_test1')->nullable();
            $table->text('phos_test2')->nullable();
    ...
    {
        Schema::dropIfExists('fche040056s');
    }
};
