...
class UsedCLEquipmentListController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $purchase_chemical_list->used_stock = $request->used_stock;
            $purchase_chemical_list->used_date = $request->used_date;
