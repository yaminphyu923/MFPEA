...
class Che040040FinanceController extends Controller
{
    /**
    ...
    {
         $this->middleware('permission:FIDSL-Che-04-01/40(Finance)', ['only' => ['index']]);
    }

    public function index()
    {
        $che040040_finances = HMMChe040040Finance::with('hmmChe040040')->get();
        return view('backend.finances.hmms.che040040s.index',compact('che040040_finances'));
    }
    ...
    {
        $che040040_finance = HMMChe040040Finance::find($id);
        return view('backend.finances.hmms.che040040s.detail',compact('che040040_finance'));
    }
    ...
    {
        $che040040_finance = HMMChe040040Finance::find($id);
        return view('backend.finances.hmms.che040040s.edit',compact('che040040_finance'));
    }
    ...
    {
        try {
            $che_finance = HMMChe040040Finance::find($id);
    ...
    {
        $che040040_finance = HMMChe040040Finance::find($id);
        return view('backend.finances.hmms.che040040s.second_add',compact('che040040_finance'));
