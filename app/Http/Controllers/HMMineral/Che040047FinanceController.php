...
class Che040047FinanceController extends Controller
{
    /**
    ...
    {
         $this->middleware('permission:FIDSL-Che-04-01/47(Finance)', ['only' => ['index']]);
    }

    public function index()
    {
        $che040047_finances = HMMChe040047Finance::with('hmmChe040047')->get();
        return view('backend.finances.hmms.che040047s.index',compact('che040047_finances'));
    }
    ...
    {
        $che040047_finance = HMMChe040047Finance::with('hmmChe040047')->find($id);
        return view('backend.finances.hmms.che040047s.detail',compact('che040047_finance'));
    }
    ...
    {
        $che040047_finance = HMMChe040047Finance::with('hmmChe040047')->find($id);
        return view('backend.finances.hmms.che040047s.edit',compact('che040047_finance'));
    }
    ...
    {
        try {
            $che_finance = HMMChe040047Finance::find($id);
    ...
    {
        $che040047_finance = HMMChe040047Finance::find($id);
        return view('backend.finances.hmms.che040047s.second_add',compact('che040047_finance'));
