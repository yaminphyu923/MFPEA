...
class Che040141FinanceController extends Controller
{
    /**
    ...
    {
         $this->middleware('permission:FIDSL-Che-04-01/41(Finance)', ['only' => ['index']]);
    }

    public function index()
    {
        $che040141_finances = HMMChe040141Finance::with('hmmChe040141')->get();
        return view('backend.finances.hmms.che040141s.index',compact('che040141_finances'));
    }
    ...
    {
        $che040141_finance = HMMChe040141Finance::find($id);
        return view('backend.finances.hmms.che040141s.detail',compact('che040141_finance'));
    }
    ...
    {
        $che040141_finance = HMMChe040141Finance::find($id);
        return view('backend.finances.hmms.che040141s.edit',compact('che040141_finance'));
    }
    ...
    {
        try {
            $che_finance = HMMChe040141Finance::find($id);
    ...
    {
        $che040141_finance = HMMChe040141Finance::find($id);
        return view('backend.finances.hmms.che040141s.second_add',compact('che040141_finance'));
